...
export const ArtworkLink = ({ img, link, label }) => {
  return (
    <NavLink to={link} className="text-white hover:text-uranian-blue no-underline group aspect-[1800/1243] overflow-hidden border-10 border-current block rounded-sm">
